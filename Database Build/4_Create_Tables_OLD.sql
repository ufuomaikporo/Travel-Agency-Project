...
(booking_no       NUMBER(8) CONSTRAINT booking_pk PRIMARY KEY,
 ...
 itinerary_no     NUMBER(8) CONSTRAINT booking_itinerary_no_nn NOT NULL,
 client_id        NUMBER(6) CONSTRAINT booking_client_id_nn NOT NULL,
 prod_category    NUMBER(3) CONSTRAINT booking_prod_categeory_nn NOT NULL,
...
(prod_supplier_id NUMBER(8) CONSTRAINT product_supplier_pk PRIMARY KEY,
...
(payment_no   NUMBER(8) CONSTRAINT payment_pk PRIMARY KEY,
 booking_no   NUMBER(8) CONSTRAINT payment_booking_no_nn NOT NULL,
 client_id    NUMBER(6) CONSTRAINT payment_client_id_nn NOT NULL,
 card_no      VARCHAR2(16) CONSTRAINT payment_card_no_nn NOT NULL,
...
(itinerary_no      NUMBER(8) CONSTRAINT trip_pk PRIMARY KEY,
 client_id         NUMBER(6) CONSTRAINT trip_client_id_nn NOT NULL,
 start_date        DATE CONSTRAINT trip_start_date_nn NOT NULL,
 end_date          DATE CONSTRAINT trip_end_date_nn NOT NULL,
 dest_code         VARCHAR2(5) CONSTRAINT trip_dest_code_nn NOT NULL,
...
(id           NUMBER(6) CONSTRAINT special_date_pk PRIMARY KEY,
 client_id    NUMBER(6) CONSTRAINT special_date_client_id_nn NOT NULL,
